...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public User getUser(UserServiceModel userViewModel) {
if (userViewModel.getUsername()!=null)
{return  this.userRepository.findByUsername(userViewModel.getUsername()).orElse(null);}
        return null;
    }
